...
<body>
        ...
        <secO>
                ...
                <partTwo>
                      ...
                      <tr><th>Serial</th><th>User ID</th><th>Username</th><th>Email</th><th>Message</th></tr>
                      ...
                      <?php
                         ...
                         echo "<tr><td>".$row["Serial"]."</td><td>".$row["userid"]."</td><td>".$row["username"]."</td><td>".$row["useremail"]."</td><td>".$row["usermessage"]."</td></tr>";
                         }
