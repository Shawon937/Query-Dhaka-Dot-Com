...
$admin = $_SESSION['adminname'];
 ...
 include('deletePoliceStation_process.php');
...
<head>
<link rel="stylesheet" href="deletePoliceStation.css" type="text/css">
...
<div class="container">  
  ...
  <form id="contact" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
    ...
    <fieldset>
      <input placeholder="Enter Serial No." type="text" name="name" value="<?= $name ?>" tabindex="1" autofocus>
