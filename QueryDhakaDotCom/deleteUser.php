...
$admin = $_SESSION['adminname'];
 ...
 include('deleteUser_process.php');
...
<head>
<link rel="stylesheet" href="deleteUser.css" type="text/css">
...
<div class="container">  
  ...
  <form id="contact" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
    ...
    <fieldset>
      <input placeholder="Enter User Id" type="text" name="name" value="<?= $name ?>" tabindex="1" autofocus>
