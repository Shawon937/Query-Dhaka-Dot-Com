...
$admin = $_SESSION['adminname'];
 ...
 include('registerRestaurant_process.php');
...
<head>
<link rel="stylesheet" href="registerRestaurant.css" type="text/css">
...
<div class="container">  
  ...
  <form id="contact" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
    ...
    <h4></h4>
     ...
     <fieldset>
      <input placeholder="Enter Restaurant name" type="text" name="id" value="<?= $id ?>" tabindex="3">
    ...
    <fieldset>
      <input placeholder="Enter Cuisine" type="text" name="email" value="<?= $email ?>" tabindex="2">
