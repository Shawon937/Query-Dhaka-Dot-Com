...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (empty($_POST["name"])) {
    $name_error = "Station Name is required";
  } else {
  ...
  if ($name_error == '' and $email_error == '' and $id_error == '' ){
      ...
      $query="UPDATE policestations SET PoliceStation='$name',Address='$email', ContactNoofOC='$message', ContactNoofDutyOfficer='$url' where Serial='$id'";
