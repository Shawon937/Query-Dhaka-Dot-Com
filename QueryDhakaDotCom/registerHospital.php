...
$admin = $_SESSION['adminname'];
 ...
 include('registerHospital_process.php');
...
<div class="container">  
  ...
  <form id="contact" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
    ...
    <h4></h4>
     ...
     <fieldset>
      <input placeholder="Enter Hospital name" type="text" name="id" value="<?= $id ?>" tabindex="3">
    ...
    <fieldset>
      <input placeholder="Enter Area" type="text" name="email" value="<?= $email ?>" tabindex="2">
