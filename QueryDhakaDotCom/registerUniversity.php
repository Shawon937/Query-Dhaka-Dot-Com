...
$admin = $_SESSION['adminname'];
 ...
 include('registerUniversity_process.php');
...
<head>
<link rel="stylesheet" href="registerUniversity.css" type="text/css">
...
<div class="container">  
  ...
  <form id="contact" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
    ...
    <h4></h4>
     ...
     <fieldset>
      <input placeholder="Enter University name" type="text" name="id" value="<?= $id ?>" tabindex="3">
